      ...
      <Stepper orientation="vertical">
        <Step active>
          ...
          <StepContent>
            ...
            <Link component="button" onClick={() => setShowBookmarklet(!showBookmarklet)} sx={{ textAlign: "left" }}>
              ブックマークレットを表示
            </Link>
            <Collapse in={showBookmarklet}>
              <Typography color="text.secondary" sx={{ mt: 1 }}>
                ※ブックマークレットとは、ブラウザのブックマークに登録して使う小さなプログラムです。
                以下の「コピー」ボタンでコピーしたコードをURLにしたブックマークを作成してください。
